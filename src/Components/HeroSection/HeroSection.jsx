...
const HeroSection = () => {
  ...
  return (
    <div
      ...
      className="mx-auto lg:h-[max(620px,_calc(92vh-49px))] h-auto bg-[radial-gradient(59.82%_121.73%_at_-9.66%_130.31%,_#00e9ea_0%,_#1f80f0_52.08%,_#005bc4_100%)]  lg:flex justify-between items-center relative overflow-hidden "
